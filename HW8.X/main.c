...
/*
 // Part 2: loop through the ASCII table        
        drawChar(0x20+i, x, y);
        ssd1306_update();
        i++;
        x = x+5;
...
*/
  ...
  // Part 3 and 4: print a message
        ...
        char message[50]; 
        sprintf(message, "fps = %2.0f", (double) ((1/(time-time_0))*24e6)); 
        drawString(message, 75,25); // draw starting at x=10,y=10
